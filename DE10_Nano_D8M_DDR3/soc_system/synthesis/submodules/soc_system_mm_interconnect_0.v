...
module soc_system_mm_interconnect_0 (
	...
	wire  [220:0] hps_ddr3_hps_f2h_sdram0_data_agent_rf_source_data;                                 // hps_ddr3_hps_f2h_sdram0_data_agent:rf_source_data -> hps_ddr3_hps_f2h_sdram0_data_agent_rsp_fifo:in_data
	...
	wire  [220:0] hps_ddr3_hps_f2h_sdram0_data_agent_rsp_fifo_out_data;                              // hps_ddr3_hps_f2h_sdram0_data_agent_rsp_fifo:out_data -> hps_ddr3_hps_f2h_sdram0_data_agent:rf_sink_data
	...
	wire          cmd_mux_src_valid;                                                                 // cmd_mux:src_valid -> hps_ddr3_hps_f2h_sdram0_data_agent:cp_valid
	wire  [219:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> hps_ddr3_hps_f2h_sdram0_data_agent:cp_data
	wire          cmd_mux_src_ready;                                                                 // hps_ddr3_hps_f2h_sdram0_data_agent:cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                               // cmd_mux:src_channel -> hps_ddr3_hps_f2h_sdram0_data_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                         // cmd_mux:src_startofpacket -> hps_ddr3_hps_f2h_sdram0_data_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                           // cmd_mux:src_endofpacket -> hps_ddr3_hps_f2h_sdram0_data_agent:cp_endofpacket
	...
	wire          hps_ddr3_hps_f2h_sdram0_data_agent_rp_valid;                                       // hps_ddr3_hps_f2h_sdram0_data_agent:rp_valid -> router_002:sink_valid
	wire  [219:0] hps_ddr3_hps_f2h_sdram0_data_agent_rp_data;                                        // hps_ddr3_hps_f2h_sdram0_data_agent:rp_data -> router_002:sink_data
	wire          hps_ddr3_hps_f2h_sdram0_data_agent_rp_ready;                                       // router_002:sink_ready -> hps_ddr3_hps_f2h_sdram0_data_agent:rp_ready
	wire          hps_ddr3_hps_f2h_sdram0_data_agent_rp_startofpacket;                               // hps_ddr3_hps_f2h_sdram0_data_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          hps_ddr3_hps_f2h_sdram0_data_agent_rp_endofpacket;                                 // hps_ddr3_hps_f2h_sdram0_data_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	soc_system_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (hps_ddr3_hps_f2h_sdram0_data_agent_rp_ready),                               //      sink.ready
		.sink_valid         (hps_ddr3_hps_f2h_sdram0_data_agent_rp_valid),                               //          .valid
		.sink_data          (hps_ddr3_hps_f2h_sdram0_data_agent_rp_data),                                //          .data
		.sink_startofpacket (hps_ddr3_hps_f2h_sdram0_data_agent_rp_startofpacket),                       //          .startofpacket
		.sink_endofpacket   (hps_ddr3_hps_f2h_sdram0_data_agent_rp_endofpacket),                         //          .endofpacket
		.clk                (pll_0_outclk2_clk),                                                         //       clk.clk
		.reset              (hps_ddr3_hps_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
