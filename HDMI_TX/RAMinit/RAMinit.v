...
//altmem_init CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" INIT_FILE="copper_640_480.bmp" INIT_TO_ZERO="NO" NUMWORDS=307218 PORT_ROM_DATA_READY="PORT_UNUSED" ROM_READ_LATENCY=1 WIDTH=24 WIDTHAD=19 clock dataout init init_busy ram_address ram_wren
//VERSION_BEGIN 20.1 cbx_altera_syncram_nd_impl 2020:06:05:12:04:51:SJ cbx_altmem_init 2020:06:05:12:04:51:SJ cbx_altsyncram 2020:06:05:12:04:51:SJ cbx_cycloneii 2020:06:05:12:04:51:SJ cbx_lpm_add_sub 2020:06:05:12:04:51:SJ cbx_lpm_compare 2020:06:05:12:04:51:SJ cbx_lpm_counter 2020:06:05:12:04:51:SJ cbx_lpm_decode 2020:06:05:12:04:51:SJ cbx_lpm_mux 2020:06:05:12:04:51:SJ cbx_mgl 2020:06:05:12:11:10:SJ cbx_nadder 2020:06:05:12:04:51:SJ cbx_stratix 2020:06:05:12:04:51:SJ cbx_stratixii 2020:06:05:12:04:51:SJ cbx_stratixiii 2020:06:05:12:04:51:SJ cbx_stratixv 2020:06:05:12:04:51:SJ cbx_util_mgl 2020:06:05:12:04:51:SJ  VERSION_END
// synthesis VERILOG_INPUT_VERSION VERILOG_2001
// altera message_off 10463


//synthesis_resources = altsyncram 1 lpm_compare 2 lpm_counter 2 reg 23 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  RAMinit_meminit_jmm
	( 
	clock,
	dataout,
	init,
	...
	wire  [23:0]   wire_int_rom_q_a;
	reg	[0:0]	capture_init;
	reg	[18:0]	delay_addr;
	wire	[18:0]	wire_delay_addr_ena;
	...
	defparam
		int_rom.init_file = "copper_640_480.bmp",
		int_rom.numwords_a = 307218,
		int_rom.operation_mode = "ROM",
		int_rom.width_a = 24,
		int_rom.widthad_a = 19,
	...
	// synopsys translate_on
	always @ ( posedge clock)
		if (wire_delay_addr_ena[17:17] == 1'b1)   delay_addr[17:17] <= wire_addr_ctr_q[17:17];
	// synopsys translate_off
	initial
		delay_addr[18:18] = 0;
	// synopsys translate_on
	always @ ( posedge clock)
		if (wire_delay_addr_ena[18:18] == 1'b1)   delay_addr[18:18] <= wire_addr_ctr_q[18:18];
	assign
		wire_delay_addr_ena = {19{(clken & rom_data_capture_state)}};
	// synopsys translate_off
	initial
		state_reg[0:0] = 0;
	// synopsys translate_on
...
module RAMinit (
	...
	RAMinit_meminit_jmm	RAMinit_meminit_jmm_component (
				.clock (clock),
				.init (init),
				.dataout (sub_wire0),
				.init_busy (sub_wire1),
